...
static void NNSi_G2dInitRndMtxStack(void);
static BOOL NNSi_G2dIsStackEmpty(void);
static BOOL NNSi_G2dStackHasEnoughCapacity(void);

static void NNSi_G2dMtxPush(void);
static void NNSi_G2dMtxPop(void);
...
static void NNSi_G2dIdentity(void);

static const MtxFx32 * NNSi_G2dGetCurrentMtx(void);
static u16 NNSi_G2dGetMtxStackPos(void);

static void NNSi_G2dSetRndMtxStackSRTransformed(void);
static BOOL NNSi_G2dIsRndCurrentMtxSRTransformed(void);
