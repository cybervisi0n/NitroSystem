...
void NNS_G2dSetupSoftwareSpriteMaterial (void)
{
    {
        G3_MaterialColorDiffAmb(GX_RGB(31, 31, 31),
                                GX_RGB(16, 16, 16),
                                TRUE
                                );

        G3_MaterialColorSpecEmi(GX_RGB(16, 16, 16),
                                GX_RGB(0, 0, 0),
                                FALSE
                                );
...
const NNSG2dExtendedSprite * NNS_G2dGetSpriteDefaultAttr (void)
{
